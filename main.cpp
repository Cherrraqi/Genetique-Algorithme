...
int main(){
    srand(time(0));
    deque<int> genotype;// vecteur qui a comme valeur le codage binaire d'une solution (population initiale) 
    ...
    float pm = 0.000005 ; //probabilié de mutation
